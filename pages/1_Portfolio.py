...
st.markdown("- Number of policies : on monthly basis, the number of policies that are renewed, newly underwritten and lapsed policies. "
            "Renewals + New Business - Lapses = Net Position in terms of Policies my month."
            "This indicator is helpful to monitor if the Business Plan ongoing well or not based on this evolution in terms of new client.")
